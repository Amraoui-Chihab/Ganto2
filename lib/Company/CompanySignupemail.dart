...
class CompanySignupemail extends StatefulWidget {
  const CompanySignupemail({super.key});

  @override
  State<CompanySignupemail> createState() => _CompanySignupemailState();
}

class _CompanySignupemailState extends State<CompanySignupemail> {
    ...
    // Check if the form is valid
      ...
      try{
        ...
        final response = await http.post(
          Uri.parse('https://ganto-app.online/public/api/company/Signup/email'),
          headers: {
