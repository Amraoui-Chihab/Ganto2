...
class ShowStudentCourses extends StatefulWidget {
  @override
  _ShowStudentCoursesState createState() => _ShowStudentCoursesState();
}

class _ShowStudentCoursesState extends State<ShowStudentCourses> {
  ...
  Widget _buildEditableCell(DateTime day, int hour) {
    ...
    FullCourse? course = _studentController.Courses.value.firstWhereOrNull((c) {
